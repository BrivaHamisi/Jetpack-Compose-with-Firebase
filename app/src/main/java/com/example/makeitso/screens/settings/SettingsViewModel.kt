...
//  listening tp the current state of the user available in the AccountService to check if the account is anonymous or not
//  val  iuState = accountService.currentUser.map {
